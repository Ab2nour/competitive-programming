def main():
    ...
    propriete_x = array("b", [0 for i in range(MAX_ZOINXIEN + 1)])
    propriete_y = array("b", [0 for i in range(MAX_ZOINXIEN + 1)])
    propriete_age = array("b", [0 for i in range(MAX_ZOINXIEN + 1)])
    propriete_tentacule = array("b", [0 for i in range(MAX_ZOINXIEN + 1)])
    ...
    def est_ami(id_zox):
        ...
        if (
            deja_vu_x[x]
            or deja_vu_y[y]
            or deja_vu_tentacule[tentacule]
            or deja_vu_age[age]
        ):
            return True
        else:
